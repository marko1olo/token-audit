...
| Claude Code, измерено | **16 158 644 905** |
| Claude Code, эквивалент по прайсу | **$14 509,26** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.51%** |
| доля вывода в объёме | 0.55% |
| завышение при наивной сумме | **×2.16** |
| крупнейшая статья расхода | **чтение кэша, 52.73%** |
