...
| Claude Code, измерено | **18 397 217 099** |
| Claude Code, эквивалент по прайсу | **$16 267,35** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.79%** |
| доля вывода в объёме | 0.54% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 53.69%** |
