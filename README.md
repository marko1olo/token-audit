...
| Claude Code, измерено | **14 944 139 518** |
| Claude Code, эквивалент по прайсу | **$13 425,92** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.46%** |
| доля вывода в объёме | 0.54% |
| завышение при наивной сумме | **×2.16** |
| крупнейшая статья расхода | **чтение кэша, 52.67%** |
