...
| Claude Code, измерено | **24 737 177 346** |
| Claude Code, эквивалент по прайсу | **$21 357,72** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **95.27%** |
| доля вывода в объёме | 0.56% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 55.24%** |
