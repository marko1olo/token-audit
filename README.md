...
| Claude Code, измерено | **21 914 477 416** |
| Claude Code, эквивалент по прайсу | **$19 201,19** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **95.04%** |
| доля вывода в объёме | 0.56% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 54.31%** |
