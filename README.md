...
| Claude Code, измерено | **24 404 876 939** |
| Claude Code, эквивалент по прайсу | **$21 101,61** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **95.25%** |
| доля вывода в объёме | 0.56% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 55.15%** |
