...
| Claude Code, измерено | **22 177 753 302** |
| Claude Code, эквивалент по прайсу | **$19 388,39** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **95.07%** |
| доля вывода в объёме | 0.56% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 54.45%** |
