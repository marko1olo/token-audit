...
| Claude Code, измерено | **18 916 774 745** |
| Claude Code, эквивалент по прайсу | **$16 647,57** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.87%** |
| доля вывода в объёме | 0.54% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 53.98%** |
