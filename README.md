...
<!-- AUTO:stamp -->
*Все числа в блоках `<!-- AUTO:… -->` подставлены `report_gen.py` 2026-08-01 08:34 из JSON-выкладок. Править данные, а не текст: `python refresh.py`.*
<!-- /AUTO -->
...
| `FULL_REPORT.md` | 47 КБ | книга данных: 7 частей, все таблицы генерируются |
...
| `snapshots.jsonl` | 47 КБ | история запусков, источник дельт |
| **прочее** | | |
