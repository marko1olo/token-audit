...
| Claude Code, измерено | **12 555 356 059** |
| Claude Code, эквивалент по прайсу | **$11 249,43** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.41%** |
| доля вывода в объёме | 0.53% |
| завышение при наивной сумме | **×2.16** |
| крупнейшая статья расхода | **чтение кэша, 52.81%** |
