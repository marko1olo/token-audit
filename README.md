...
| Claude Code, измерено | **18 328 834 880** |
| Claude Code, эквивалент по прайсу | **$16 212,22** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.78%** |
| доля вывода в объёме | 0.54% |
| завышение при наивной сумме | **×2.14** |
| крупнейшая статья расхода | **чтение кэша, 53.66%** |
