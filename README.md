...
| Claude Code, измерено | **25 097 108 454** |
| Claude Code, эквивалент по прайсу | **$21 641,46** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **95.29%** |
| доля вывода в объёме | 0.56% |
| завышение при наивной сумме | **×2.13** |
| крупнейшая статья расхода | **чтение кэша, 55.32%** |
