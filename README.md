...
| Claude Code, измерено | **20 252 707 919** |
| Claude Code, эквивалент по прайсу | **$17 694,01** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.99%** |
| доля вывода в объёме | 0.54% |
| завышение при наивной сумме | **×2.13** |
| крупнейшая статья расхода | **чтение кэша, 54.44%** |
