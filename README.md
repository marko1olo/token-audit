...
| Claude Code, измерено | **12 075 583 142** |
| Claude Code, эквивалент по прайсу | **$10 791,84** |
| Antigravity | счётчика не существует |
| доля кэш-чтения в объёме Claude Code | **94.42%** |
| доля вывода в объёме | 0.53% |
| завышение при наивной сумме | **×2.16** |
| крупнейшая статья расхода | **чтение кэша, 52.96%** |
