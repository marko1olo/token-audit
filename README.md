...
![TOKEN-AUDIT Banner](https://raw.githubusercontent.com/marko1olo/gigahrush/main/docs/cyber_banner.jpg)
...
---
<p align="center">
  <a href="https://twitter.com/intent/tweet?text=Check%20out%20token-audit%20on%20GitHub!&url=https%3A%2F%2Fmarko1olo.github.io%2Ftoken-audit%2F"><img src="https://img.shields.io/badge/Share-Twitter%2FX-1DA1F2?style=for-the-badge&logo=x" alt="Share on X"/></a> &nbsp;
  <a href="https://news.ycombinator.com/submitlink?u=https%3A%2F%2Fmarko1olo.github.io%2Ftoken-audit%2F&t=Check%20out%20token-audit%20on%20GitHub!"><img src="https://img.shields.io/badge/Submit-Hacker%20News-FF6600?style=for-the-badge&logo=y-combinator" alt="Submit to HN"/></a> &nbsp;
  <a href="https://reddit.com/submit?url=https%3A%2F%2Fmarko1olo.github.io%2Ftoken-audit%2F&title=Check%20out%20token-audit%20on%20GitHub!"><img src="https://img.shields.io/badge/Post-Reddit-FF4500?style=for-the-badge&logo=reddit" alt="Post on Reddit"/></a>
</p>
---
---
...
| **4** | ![Глава 4](docs/comic/comic_panel_4.jpg) | **Телефонная Ферма:** 26.46 млрд токенов у Николая ($23,269.04 личного эквивалента). |
...
<!-- AUTO:stamp -->
*Все числа в блоках `<!-- AUTO:… -->` подставлены `report_gen.py` 2026-07-31 16:17 из JSON-выкладок. Править данные, а не текст: `python refresh.py`.*
<!-- /AUTO -->
...
| **обработка** | | |
| `build_dashboard.py` | 108 КБ | сборка dashboard.html без внешних зависимостей |
...
| `README.md` | 26 КБ | описание инструментария и методики |
| `SUMMARY.md` | 55 КБ | сводка: проза авторская, числа в AUTO-блоках |
| `dashboard.html` | 399 КБ | интерактивный дашборд, самодостаточный |
| **данные** | | |
...
| `snapshots.jsonl` | 46 КБ | история запусков, источник дельт |
| **прочее** | | |
